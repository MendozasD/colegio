(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))c(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&c(r)}).observe(document,{childList:!0,subtree:!0});function s(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function c(e){if(e.ep)return;e.ep=!0;const a=s(e);fetch(e.href,a)}})();function d(i){i.innerHTML+=`<nav id="navbar">
  ...
  <section id="menu">
    ...
    <img src="./rainbow.png" id="rainbow" alt="rainbow" />
  </section>
  <div id="btn_menu">
    <span class="material-symbols-outlined">menu</span>
  </div>
</nav>`}function u(){let i=document.querySelectorAll(".loader_pic"),n=0;i.forEach(s=>{s.addEventListener("load",()=>{n++,n===i.length&&setTimeout(()=>{console.log(n),document.querySelector("#loader").style.display="none"},1e3)})})}document.querySelector("#app").innerHTML=`
  <div id="background">
...
`;d(document.querySelector("#app"));const o=document.querySelector("#menu"),m=document.querySelector("#btn_close_menu"),t=document.querySelectorAll(".nav_link"),l=document.querySelector("#btn_menu"),p=getComputedStyle(l).display;l.addEventListener("click",()=>{o.style.display="grid",o.style.transform="translateY(0)",o.style.borderRadius="0 0 200px 200px",setTimeout(()=>{o.style.borderRadius="0 0 50px 50px"},300)});m.addEventListener("click",()=>{o.style.borderRadius="0 0 200px 200px",setTimeout(()=>{o.style.transform="translateY(-100%)"},400)});function v(i,n,s){setTimeout(()=>{i.style.transform="translateY(0)"},100),setTimeout(()=>{n.style.transform="translateY(0)"},150),setTimeout(()=>{s.style.transform="translateY(0)"},200)}v(t[0],t[1],t[2]);t.forEach(i=>{i.addEventListener("click",()=>{o.style.borderRadius="0 0 200px 200px",setTimeout(()=>{p==="none"?o.style.transform="translateY(0)":o.style.transform="translateY(-100%)"},400)})});u();
